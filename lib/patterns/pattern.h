...
protected:
	...
	class PALAPELIBASE_EXPORT Pattern : public QObject
	{
		...
		public:
			...
			enum Mode
			{
				CreatePuzzle,    ///< perform necessary calculations and create pieces and relations (default)
				SimulateCreation ///< perform necessary calculations (e.g. piece count), but create neither pieces nor relations
			};
