...
#  LIBPALA_INCLUDES         - The minimum set of include dirs which slicers will have to define
...
if (LIBPALA_FOUND)
	...
	set(LIBPALA_INCLUDES ${KDE4_INCLUDES} ${LIBPALA_INCLUDE_DIR})
	set(LIBPALA_LIBRARIES ${KDE4_KDECORE_LIBS} ${QT_QTGUI_LIBRARY} ${LIBPALA_LIBRARY})
	mark_as_advanced(LIBPALA_INCLUDES LIBPALA_LIBRARIES)
endif (LIBPALA_FOUND)
